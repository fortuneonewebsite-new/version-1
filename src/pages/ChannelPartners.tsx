...
const ChannelPartners: React.FC = () => {
  ...
  const benefits = [
    ...
    {
      icon: DocumentIcon,
      title: "Tailored marketing resources",
      description: "",
    },
    {
      icon: CurrencyDollarIcon,
      title: "Competitive and enticing commission structure",
      description: "",
    },
  ];
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (
      !leadForm.partnerPhone.trim() ||
      !leadForm.leadFirstName.trim() ||
      !leadForm.leadContact.trim()
    ) {
      alert(
        "Please fill Registered Channel Partner Phone Number, Lead First Name and Lead Contact."
      );
      return;
    }
    ...
    const bodyLines = [
      `Registered Channel Partner Phone Number: ${
        leadForm.partnerPhone || "N/A"
      }`,
      ...
      <section className="relative min-h-[60vh] overflow-hidden py-16">
        ...
        <div className="relative z-10 py-20 px-8 md:px-16 max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-20"
          >
            <h2 className="text-3xl font-serif italic text-[#664930]">
              Why Partner With Us
            </h2>
            ...
            {benefits.map((benefit, index) => (
              <React.Fragment key={index}>
                ...
                >
                  ...
                  >
                    <benefit.icon
                      className="h-14 w-14 text-[#664930]"
                      strokeWidth={1.5}
                    />
                  </motion.div>
                ...
                {index < benefits.length - 1 && (
                  <div className="hidden md:block h-20 w-px bg-[#664930]/30"></div>
                )}
              </React.Fragment>
            ))}
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-[#F5F5F0] to-[#FAFAF8]">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-[#664930] leading-tight">
                Building beyond walls and spaces.
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                At Fortune One, every project begins with a vision — to redefine
                what modern living feels like. We focus on thoughtful design,
                meaningful details, and sustainable choices that add long-term
                value to every community we create.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Our goal is simple — to build environments where comfort meets
                purpose, and every day feels inspired.
              </p>
              <div className="pt-4">
                <p className="text-xl font-semibold text-[#664930]">
                  We don't just build for today.
                </p>
                <p className="text-xl font-semibold text-[#664930]">
                  We build for what tomorrow deserves.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 bg-[#FFFBF7]">
        <div className="max-w-7xl mx-auto px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl font-serif italic text-[#664930] mb-4">
              Testimonials
            </h2>
                    ...
                    {testimonials
                      ...
                      .map((testimonial, index) => (
                        <motion.div
                          ...
                          className="bg-gradient-to-br from-[#3A3F4C] to-[#2A2F3C] rounded-3xl p-10 text-white shadow-2xl border border-[#C9A55A]/20 hover:shadow-3xl hover:border-[#C9A55A]/40 transition-all duration-300"
                        >
                          <div className="mb-8">
                            <span className="text-6xl text-white/40 font-serif">
                              "
                            </span>
                          </div>
                          <p className="text-base leading-relaxed mb-12 text-white/90">
                            {testimonial.text}
                          </p>
                          <div>
        ...
        {showPartnerForm && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-lg"
            >
              ...
              >
                ...
                <div className="flex justify-between mt-6">
                  ...
                  <button
                    type="submit"
                    className="bg-[#1a1a27] text-white px-5 py-2 rounded-lg hover:bg-[#33334d] transition"
                  >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <label className="block font-medium text-gray-700 mb-1">
                    Lead First Name <span className="text-red-500">*</span>
                  </label>
                  <input
                    name="leadFirstName"
                    value={leadForm.leadFirstName}
                    onChange={onLeadChange}
                    type="text"
                    className="w-full bg-gray-100 rounded-md p-3"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    value={leadForm.projectInterested}
                    onChange={onLeadChange}
                    className="w-full bg-gray-100 rounded-md p-3"
                  >
                    <option>Vista</option>
